class OrganizationMembersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @organization_member.save
        format.html { redirect_to organization_path(@organization_member.organization_id), notice: 'Organization member was successfully invited.' }
  ...
  private
    ...
    def organization_member_params
      params.fetch(:organization_member, {}).permit(:user_id, :organization_id)
    end
end
