...
user0.profile_page.update(user: user0, name: "Alfonso Vera", biography: "Hola, soy alumno de la universidad de los andes", location: "Santiago", )
user1.profile_page.update(user: user1, name: "Gianfranco Traverso", biography: "Hola, soy alumno de la universidad de los andes", location: "Santiago", )
user2.profile_page.update(user: user2, name: "Stefano Garcia", biography: "Hola, soy alumno de la universidad de los andes", location: "Santiago", )
user3.profile_page.update(user: user3, name: "Pedro Perez", biography: "Hola, soy alumno de la universidad de los andes", location: "Santiago", )
user4.profile_page.update(user: user4, name: "Antonio Gonzales", biography: "Hola, soy alumno de la universidad de los andes", location: "Santiago", )
user5.profile_page.update(user: user5, name: "Agustin Diaz", biography: "Hola, soy alumno de la universidad de los andes", location: "Santiago", )
user6.profile_page.update(user: user6, name: "Agueda Cuellar", biography: "Hola, soy alumno de la universidad de los andes", location: "Santiago", )
user7.profile_page.update(user: user7, name: "Naima Tejera", biography: "Hola, soy alumno de la universidad de los andes", location: "Santiago", )
user8.profile_page.update(user: user8, name: "Aurora Planas", biography: "Hola, soy alumno de la universidad de los andes", location: "Santiago", )
user9.profile_page.update(user: user9, name: "Laila Julian", biography: "Hola, soy alumno de la universidad de los andes", location: "Santiago", )

proimg0 = ProfileImage.create(profile_page: user1.profile_page, image:  "img (18).jpg")
proimg1 = ProfileImage.create(profile_page: user1.profile_page, image: "img (35).jpg")
proimg2 = ProfileImage.create(profile_page: user1.profile_page, image: "img (73).jpg")
proimg3 = ProfileImage.create(profile_page: user1.profile_page, image: "mountain1.jpg")
proimg4 = ProfileImage.create(profile_page: user1.profile_page, image: "mountain2.jpg")
proimg5 = ProfileImage.create(profile_page: user1.profile_page, image: "mountain3.jpg")
